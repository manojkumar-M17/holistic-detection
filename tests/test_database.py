...
class TestDatabaseInitialization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Patch DB_PATH inside db_manager
...
class TestLogIncident(unittest.TestCase):
    ...
    def test_risk_score_saved(self):
...
class TestUpdateIncidentStatus(unittest.TestCase):
...
class TestCSVExport(unittest.TestCase):
    ...
    def test_csv_contains_incident_data(self):
...
class TestClearIncidents(unittest.TestCase):
    ...
    def test_clear_all_incidents(self):
        ...
        incidents_before = db_manager.get_all_incidents()

        self.assertEqual(
            len(incidents_before),
            2
        )

        db_manager.clear_all_incidents()

        incidents_after = db_manager.get_all_incidents()
